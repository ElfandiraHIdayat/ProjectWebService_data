...
import daftar.makan.daftar.makan.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("daftar.makan_daftar.makan_jar_0.0.1-SNAPSHOTPU2");
